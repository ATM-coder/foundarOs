    ...
    return (
      ...
      >
        <div className="flex flex-col items-center gap-3 opacity-70">
          {LoadingSpinner ? <LoadingSpinner /> : <div className="w-8 h-8 rounded-full border-2 border-[var(--space-brand-primary)] border-t-transparent animate-spin" />}
    ...
    <>
      ...
      <div className="fixed inset-0 flex overflow-hidden" style={rootStyle}>
        ...
        <aside
          ...
          style={{ backgroundColor: 'var(--space-surface-panel)', borderRight: '1px solid var(--space-border-default)' }}
        >
